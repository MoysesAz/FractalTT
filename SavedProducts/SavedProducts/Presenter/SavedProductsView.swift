...
public protocol SavedProductsViewProtocol {
    func emptySearchViewOn()
    func emptySearchViewOff()
}

final public class SavedProductsView: UIView {
...
extension SavedProductsView: SavedProductsViewProtocol {
