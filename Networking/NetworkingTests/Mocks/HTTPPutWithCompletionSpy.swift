...
class HTTPPutWithCompletionSpy: HTTPPutWithCompletionProtocol {
    var url: String?
    ...
    func handler<T: Decodable>(body: Data?,
        ...
        if let result = resultToReturn {
            ...
            let defaultError = NSError(domain: "MockError",
                                       code: -1, userInfo: [NSLocalizedDescriptionKey: "No result provided in mock."])
