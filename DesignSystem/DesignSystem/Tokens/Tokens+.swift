...
extension Luxux.Tokens.Colors {
    public struct Background {
        public static var lxPrimary: UIColor {
            BugFixColor.getColor(for: .init(red: 1, green: 1, blue: 1, alpha: 1), dark: .init(red: 0, green: 0, blue: 0, alpha: 1))
            //                    UIColor(named: "New/Background/Primary") ?? .red
        }
        public static var lxSecondy: UIColor {
            BugFixColor.getColor(for: .init(red: 0.4, green: 0.4, blue: 0.4, alpha: 1), dark: .init(red: 0.4, green: 0.4, blue: 0.4, alpha: 1))
...
extension Luxux.Tokens.Colors {
    public struct Font {
        public static var lxPrimary: UIColor {
            BugFixColor.getColor(for: .init(red: 0.4, green: 0.4, blue: 0.4, alpha: 1), dark: .init(red: 1, green: 1, blue: 1, alpha: 1))
        }
    }
